...
case class S3ObjectFetching[Response](s3Client: S3AsyncClient, transformer: Transformer[Response])
  ...
  /**
   * *All* Future-mapping occurring **in this particular class** performs very limited non-blocking computation.
   * Hence, we can make creation & usage of this class easier by supplying a minimal 'parasitic' ExecutionContext,
   * rather than asking the user of the class to provide an ExecutionContext.
   *
   * See also: https://tersesystems.com/blog/2024/06/20/executioncontext.parasitic-and-friends/
   */
